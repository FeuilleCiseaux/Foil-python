...
def __define_list_predicates():
  import operator
  from content.Foil-python.trimlogic.term import VariableFactory, Term
  from content.Foil-python.trimlogic.predicate import RuleBasedPredicate, ListPredicate
...
def __define_arithmetic_predicates():
  from content.Foil-python.trimlogic.predicate import IsPredicate
  global est
  est = IsPredicate()
  
def __define_type_predicates():
  from content.Foil-python.trimlogic.predicate import RuleBasedPredicate, create_python_boolean_predicate
...
def __define_algorithmetic_predicates():
  from content.Foil-python.trimlogic.term import VariableFactory
  from content.Foil-python.trimlogic.predicate import CutPredicate, FailPredicate, RuleBasedPredicate
